...
The function prints out the text a spruce!, and the a spruce tree, the size of which is specified by the
argument.
...
If the shape of the spruce looks correct, but the left edge of the tree is not touching the left edge of 
